  ...
  return (
    ...
    <div className="auth-page">
      ...
      <form className="auth-card" onSubmit={handleSubmit}>
        ...
        <h1>Login</h1>
        // conditional rendering: // if error = "", nothing appears // if error
        = "Invalid password", React renders "Invalid password"
        ...
        // create: No account? Register // "No account?"" appears as normal
        static text // "Register" is a clickable hyperlink
        <p>
